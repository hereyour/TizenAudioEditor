var WaveSurfer = {
    ...
    drawBuffer: function () {
        ...
        console.log("drawBuffer_duration",this.getDuration());
    ...
    load: function (url, peaks) {
        console.log("wave_load");
        console.log("this.params.backend",this.params.backend);
    ...
    loadMediaElement: function (url, peaks) {
        ...
        console.log("wave_loadMediaElement");
        this.tmpEvents.push(
